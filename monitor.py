...
if __name__ == "__main__":
    ...
    while(1):    
        ...
        for position in fetched_sessions:
            ...
            # FIRST Search Conditional Orders if Stop Loss already exists with 'qty'=position size AND 'trigger_price' >= within allowed range
            ...
            print(fetched_conditional_orders)
